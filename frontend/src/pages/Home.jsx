      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl gap-6">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-gray-800 leading-tight">
            ...
            <span className="relative inline-block">
              ...
              <span className="absolute bottom-1 left-0 h-3 w-full rounded-sm bg-gray-300 opacity-50 -z-0" />
            </span>{" "}
            here.
          </h1>
        </div>
        ...
        >
          <p className="text-base md:text-lg text-gray-500 max-w-md leading-relaxed">
            A clean, distraction-free space to capture your thoughts, ideas, and
        ...
        >
          <NavLink
            to="/signup"
            className="group relative inline-flex items-center gap-2 rounded-xl bg-gray-800 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:bg-gray-700 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
          >
            Get Started
            <svg
